...
/************ Server7.java                                               *******************/
/************ This file implements Server 7 for tree based quorum        *******************/
...
public class Server7 {
  ...
  public class C1thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(7010); // setup server side socket				
            ...
            if (message.contains("REQUEST")) {
              ...
              while (executed == false) {
                ...
                if (((peekTsInt1 < peekTsInt2) || (peekTsInt1 == peekTsInt2)) && ((peekTsInt1 < peekTsInt3) || (peekTsInt1 == peekTsInt3)) && ((peekTsInt1 < peekTsInt4) || (peekTsInt1 == peekTsInt4)) && ((peekTsInt1 < peekTsInt5) || (peekTsInt1 == peekTsInt5)) && (locked == false)) {
                  ...
                  locked = true;
                  executed = true;
                  outBufferString = new String(Integer.toString((int) timestamp) + " " + "GRANT" + " " + "SERVER7");
  ...
  public class C2thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(7011); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C3thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(7012); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C4thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(7013); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C5thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(7014); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class s0thread extends Thread {
...

    {
      ...
      try {
        ...
        socket = new Socket(Server0, 11016);
  ...
  public static void main(String arg[]) throws Exception {
    ...
    Server7 computer = new Server7();
    Server7.C1thread client1 = computer.new C1thread();
    Server7.C2thread client2 = computer.new C2thread();
    Server7.C3thread client3 = computer.new C3thread();
    Server7.C4thread client4 = computer.new C4thread();
    Server7.C5thread client5 = computer.new C5thread();
    Server7.s0thread server0 = computer.new s0thread();
