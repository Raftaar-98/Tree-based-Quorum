...
/************ Server4.java                                               *******************/
/************ This file implements Server 4 for tree based quorum        *******************/
...
public class Server4 {
  ...
  public class C1thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(4010); // setup server side socket				
            ...
            if (message.contains("REQUEST")) {
              ...
              while (executed == false) {
                ...
                if (((peekTsInt1 < peekTsInt2) || (peekTsInt1 == peekTsInt2)) && ((peekTsInt1 < peekTsInt3) || (peekTsInt1 == peekTsInt3)) && ((peekTsInt1 < peekTsInt4) || (peekTsInt1 == peekTsInt4)) && ((peekTsInt1 < peekTsInt5) || (peekTsInt1 == peekTsInt5)) && (locked == false)) {
                  ...
                  locked = true;
                  executed = true;
                  outBufferString = new String(Integer.toString((int) timestamp) + " " + "GRANT" + " " + "SERVER4");
  ...
  public class C2thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(4011); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C3thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(4012); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C4thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(4013); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C5thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(4014); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class s0thread extends Thread {
...

    {
      ...
      try {
        ...
        socket = new Socket(Server0, 11013);
  ...
  public static void main(String arg[]) throws Exception {
    ...
    Server4 computer = new Server4();
    Server4.C1thread client1 = computer.new C1thread();
    Server4.C2thread client2 = computer.new C2thread();
    Server4.C3thread client3 = computer.new C3thread();
    Server4.C4thread client4 = computer.new C4thread();
    Server4.C5thread client5 = computer.new C5thread();
    Server4.s0thread server0 = computer.new s0thread();
