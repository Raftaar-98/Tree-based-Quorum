...
/************ Client4.java                                               *******************/
/************ This file implements client 4 for tree based quorum        *******************/
...
public class Client4 {
  ...
  public class client {
    ...
    public client() throws Exception {
      socketClient0 = new Socket(Server0, 11003);
      socketClient1 = new Socket(Server1, 10003);
      socketClient2 = new Socket(Server2, 2003);
      socketClient3 = new Socket(Server3, 3003);
      socketClient4 = new Socket(Server4, 4013);
      socketClient5 = new Socket(Server5, 5003);
      socketClient6 = new Socket(Server6, 6003);
      socketClient7 = new Socket(Server7, 7013);

    }

  }
  public static void main(String arg[]) throws Exception {
    Client4 computer = new Client4();
    Client4.client client1 = computer.new client();
    ...
    while (count < 20) {
      ...
      while (executed == false) {
        ...
        if ((granted[0] == 1) && (granted[1] == 1) && (granted[3] == 1) && (executed == false)) {
          ...
          System.out.println("Client 4 entering critical section for " + (count + 1) + " count time: " + enter_time);
