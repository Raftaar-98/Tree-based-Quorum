...
/************ Client2.java                                               *******************/
/************ This file implements client 2 for tree based quorum        *******************/
...
public class Client2 {
  ...
  public class client {
    ...
    public client() throws Exception {
      socketClient0 = new Socket(Server0, 11001);
      socketClient1 = new Socket(Server1, 10001);
      socketClient2 = new Socket(Server2, 2001);
      socketClient3 = new Socket(Server3, 3001);
      socketClient4 = new Socket(Server4, 4011);
      socketClient5 = new Socket(Server5, 5001);
      socketClient6 = new Socket(Server6, 6001);
      socketClient7 = new Socket(Server7, 7011);

    }

  }
  public static void main(String arg[]) throws Exception {
    Client2 computer = new Client2();
    Client2.client client1 = computer.new client();
    ...
    while (count < 20) {
      ...
      while (executed == false) {
        ...
        if ((granted[0] == 1) && (granted[1] == 1) && (granted[3] == 1) && (executed == false)) {
          ...
          System.out.println("Client 2 entering critical section for " + (count + 1) + " count time: " + enter_time);
