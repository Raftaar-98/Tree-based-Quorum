...
/************ Server3.java                                               *******************/
/************ This file implements Server 3 for tree based quorum        *******************/
...
public class Server3 {
  ...
  public class C1thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(3000); // setup server side socket				
            ...
            if (message.contains("REQUEST")) {
              ...
              while (executed == false) {
                ...
                if (((peekTsInt1 < peekTsInt2) || (peekTsInt1 == peekTsInt2)) && ((peekTsInt1 < peekTsInt3) || (peekTsInt1 == peekTsInt3)) && ((peekTsInt1 < peekTsInt4) || (peekTsInt1 == peekTsInt4)) && ((peekTsInt1 < peekTsInt5) || (peekTsInt1 == peekTsInt5)) && (locked == false)) {
                  ...
                  locked = true;
                  executed = true;
                  outBufferString = new String(Integer.toString((int) timestamp) + " " + "GRANT" + " " + "SERVER3");
  ...
  public class C2thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(3001); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C3thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(3002); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C4thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(3003); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class C5thread extends Thread {
...

    {
      ...
      try {
        ...
        server = new ServerSocket(3004); // setup server side socket				
        socketServer = server.accept(); // Listen to incoming connections
  ...
  public class s0thread extends Thread {
...

    {
      ...
      try {
        ...
        socket = new Socket(Server0, 11012);
  ...
  public static void main(String arg[]) throws Exception {
    ...
    Server3 computer = new Server3();
    Server3.C1thread client1 = computer.new C1thread();
    Server3.C2thread client2 = computer.new C2thread();
    Server3.C3thread client3 = computer.new C3thread();
    Server3.C4thread client4 = computer.new C4thread();
    Server3.C5thread client5 = computer.new C5thread();
    Server3.s0thread server0 = computer.new s0thread();
