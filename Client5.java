...
/************ Client5.java                                               *******************/
/************ This file implements client 5 for tree based quorum        *******************/
...
public class Client5 {
  ...
  public class client {
    ...
    public client() throws Exception {
      socketClient0 = new Socket(Server0, 11004);
      socketClient1 = new Socket(Server1, 10004);
      socketClient2 = new Socket(Server2, 2004);
      socketClient3 = new Socket(Server3, 3004);
      socketClient4 = new Socket(Server4, 4014);
      socketClient5 = new Socket(Server5, 5004);
      socketClient6 = new Socket(Server6, 6004);
      socketClient7 = new Socket(Server7, 7014);

    }

  }
  public static void main(String arg[]) throws Exception {
    Client5 computer = new Client5();
    Client5.client client1 = computer.new client();
    ...
    while (count < 20) {
      ...
      while (executed == false) {
        ...
        if ((granted[0] == 1) && (granted[1] == 1) && (granted[3] == 1) && (executed == false)) {
          ...
          System.out.println("Client 5 entering critical section for " + (count + 1) + " count time: " + enter_time);
